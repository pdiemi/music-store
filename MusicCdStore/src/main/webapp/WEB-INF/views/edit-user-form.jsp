    ...
    <div class="container">
        <form:form modelAttribute="customer" name="userForm" onSubmit="return (userFormValidate())">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-form-label" for="userEmail" id="emailLabel">Email (email cannot be changed) *:</label>
                    <form:input path="userEmail" class="form-control" id="email" name="email" type="email" required="true" readonly="true"/>
                ...
                <div class="form-group">
                    <label class="col-form-label" for="username" id="usernameLabel">Username (username cannot be changed) *:</label>
                    <form:input path="username" class="form-control" id="username" name="username" required="true" readonly="true"/>
            ...
            <a href="/index/user={username}" class="btn btn-outline-secondary" role="button">Cancel</a>
