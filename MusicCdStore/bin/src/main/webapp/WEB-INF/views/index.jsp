    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://img.freepik.com/free-photo/empty-wooden-table-with-smoke-float-up-dark-background_68495-135.jpg?size=626&ext=jpg" alt="image-1" width="1100" height="500">
        ...
        <div class="carousel-item">
          <img src="https://img.freepik.com/free-photo/empty-wooden-table-with-smoke-float-up-dark-background_68495-135.jpg?size=626&ext=jpg" alt="image-2" width="1100" height="500">
          <div class="carousel-caption">
            <h3>Chicago</h3>
        ...
        <div class="carousel-item">
          <img src="https://img.freepik.com/free-photo/empty-wooden-table-with-smoke-float-up-dark-background_68495-135.jpg?size=626&ext=jpg" alt="image-3" width="1100" height="500">
          <div class="carousel-caption">
            <h3>New York</h3>
